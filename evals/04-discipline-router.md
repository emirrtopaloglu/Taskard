...
### A. Nano Task (⚡ Nano Gear -> Zero Over-Firing)
...
### B. Standard Feature (🚀 Express Gear -> Targeted Review Gate)
...
**Checks:**
- [ ] Classified as Express gear; created point-to-range `brief.md`.
...
### C. Complex Multi-Lane Feature (🏛️ Full Gear -> DAG & Worktrees)
...
**Checks:**
- [ ] Classified as Full gear with explicit architectural justification.
