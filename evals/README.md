...
- [`01-micro-commit.md`](01-micro-commit.md) — Fast mode evaluation (single brief/prompt, command evidence check).
- [`02-feature-lane.md`](02-feature-lane.md) — Pro mode evaluation (spec -> lane -> implementer -> reviewer gate -> fix cycle).
